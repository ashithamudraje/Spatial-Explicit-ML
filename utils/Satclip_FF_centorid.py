...
# # Navigate to the parent's parent directory
# parent_dir = os.path.dirname(current_dir)
# sys.path.append(parent_dir)
# sys.path.append(current_dir)


# satclipdir = os.path.join(parent_dir, 'satclip')
# sys.path.append(satclipdir)

# satclipdir2 = os.path.join(satclipdir, 'satclip')
# sys.path.append(satclipdir2)

# print('parent_dir:----------',parent_dir)
# print('current:__________',current_dir)
# print('satclipdir load:__________',satclipdir)
# print('satclipdir2 load:__________',satclipdir2)
...
def load_satclip_model(satclip_path):
    ...
    centroid_model = get_satclip(satclip_path, device=device)  # Only loads location encoder by default
...
if __name__ == "__main__":
    ...
    centroid_model = load_satclip_model(satclip_path)
    ...
    for i in range(5):
        ...
        num_epochs = 20
        patience = 5
        save_path = f'/netscratch/mudraje/spatial-explicit-ml/scripts/models/centroid/satclipFFcentroid_best_model_exp_{i+1}.pt'  # Define save path for this experiment
