...
if __name__ == "__main__":
    ...
    # Assuming cooordinates for each country have 2 features (longitude, latitude)
    input_size = 2
    hidden_size = 20  # You can adjust this based on your problem
    output_size = 64  # Adjust based on your problem

    # Create an instance of the CoordinatesNN
    coordinates_model = CoordinatesNN(input_size, hidden_size, output_size)
