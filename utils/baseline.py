...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        num_epochs = 15
        patience = 5
        save_path = f'/netscratch/mudraje/spatial-explicit-ml/scripts/models/baseline/best_model_exp_{i+1}.pt'  # Define save path for this experiment
        ...
        for country, _ in country_datasets.items():
            predictions = inference(test_normalized_input_data[country], model)
